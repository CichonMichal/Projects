    ...
    <a href="index.php"><banner class="banner-image">Rzut na Graczy</banner></a>
        ...
        <div class="row">
            <div class="col-sm-8 body-style main-body">
                <div class="content user-display">
                <!-- logged in user information -->
                    <div class="col-xs-12">
                        <?php  if (isset($_SESSION['username'])) : ?>
                            <h1 class="margin">Oto twoje dane podróżniku <strong style="color: #E72C02;"><?php echo $_SESSION['username']; ?>!</strong></h1>
                            <?php
                            ...
                            if ($result = $db->query($query)) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo'   
                                            ...
                                            <div class="row">
                                                <div class="col-3 info">
                                                    <p>Rola: <p2 class="strong">' .$experience. '</p2></p>
                                                </div>
                                                <div class="col-7 info">
                                                    <p>Doświadczenie: <p2 class="strong">' .$role. '</p2></p>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 info">
                                                    <p>Twoje informacje: <br><br>' .$info. '</p>
                                                </div>
                                            </div>';
                                        }
